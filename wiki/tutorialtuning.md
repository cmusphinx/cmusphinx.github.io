...
command `sox --i /path/to/audio/file`. Find more information here: [ What is sample rate](http://cmusphinx.github.io/wiki/faq#qwhat_is_sample_rate_and_how_does_it_affect_accuracy ) 
